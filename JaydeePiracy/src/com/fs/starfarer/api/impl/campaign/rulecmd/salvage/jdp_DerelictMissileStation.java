...
public class jdp_DerelictMissileStation extends BaseCommandPlugin {
	...
	public jdp_DerelictMissileStation() {
	}
	
	public jdp_DerelictMissileStation(SectorEntityToken entity) {
		init(entity);
	}
	...
	public boolean execute(String ruleId, InteractionDialogAPI dialog, List<Token> params, Map<String, MemoryAPI> memoryMap) {
		...
		if (command.equals("gen_jdp_DerelictMissileAddLoot")) {
			gen_jdp_DerelictMissileAddLoot();
		}
	...
	protected void gen_jdp_DerelictMissileAddLoot() {
		...
		salvage.addSpecial(new SpecialItemData("industry_bp", "jdp_pksilo"), 1);
		salvage.sort();
	}
