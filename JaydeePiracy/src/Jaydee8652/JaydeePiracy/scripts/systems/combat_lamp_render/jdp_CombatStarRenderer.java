...
public class jdp_CombatStarRenderer extends BaseCombatLayeredRenderingPlugin {
     ...
     */
    public jdp_CombatStarRenderer(float baseRadius, float pitch, float tilt, float rotationSpeed, int numSlices, int numStacks, SpriteAPI sprite, boolean blend) {
