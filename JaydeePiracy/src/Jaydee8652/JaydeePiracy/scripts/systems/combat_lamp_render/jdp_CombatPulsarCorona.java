...
public class jdp_CombatPulsarCorona implements jdp_CombatAuroraRenderer.CombatAuroraRendererDelegate, jdp_CombatFlareManager.CombatFlareManagerDelegate {
    ...
    protected jdp_CombatAuroraRenderer renderer;
    protected jdp_CombatFlareManager flareManager;
    protected CombatCoronaParams params;

    protected final jdp_CombatRangeBlockerUtil blocker = null;
    ...
    public jdp_CombatRangeBlockerUtil getAuroraBlocker() {
        return blocker;
    }
...
//	if (true) return -4000f;
    ...
    public jdp_CombatFlareManager getFlareManager() {
        return flareManager;
    }
