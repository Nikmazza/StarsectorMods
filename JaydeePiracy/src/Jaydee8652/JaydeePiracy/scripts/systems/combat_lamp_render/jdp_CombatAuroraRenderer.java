...
public class jdp_CombatAuroraRenderer {
    public interface CombatAuroraRendererDelegate {
        ...
        jdp_CombatRangeBlockerUtil getAuroraBlocker();
    }

    private final CombatAuroraRendererDelegate delegate;
    private float phaseAngle;
    public jdp_CombatAuroraRenderer(CombatAuroraRendererDelegate delegate) {
...
//		System.out.println("Aurora outer: " + delegate.getAuroraOuterRadius());
        ...
        jdp_CombatRangeBlockerUtil blocker = delegate.getAuroraBlocker();
