...
public class jdp_CombatmasterLidarArrayStats extends BaseShipSystemScript {

	public static String LIDAR_WINDUP = "lidar_windup";
	
	public static Color WEAPON_GLOW = new Color(50,255,50,155);
	...
	protected List<LidarDishData> dishData = new ArrayList<jdp_CombatmasterLidarArrayStats.LidarDishData>();
