...
public class jdp_QuickdrawLidarArrayStats extends BaseShipSystemScript {
	...
	protected List<LidarDishData> dishData = new ArrayList<jdp_QuickdrawLidarArrayStats.LidarDishData>();
