 ...
 */
public class jdp_PhaseOrionDeviceStats extends BaseShipSystemScript {
	...
	public jdp_PhaseOrionDeviceStats() {
...
//					}
	...
	public boolean isUsable(ShipSystemAPI system, ShipAPI ship) {
		if (ship.getEngineController().isFlamedOut() || ship.getEngineController().isFlamingOut() || ship.isPhased()) {
			return false;
		}
