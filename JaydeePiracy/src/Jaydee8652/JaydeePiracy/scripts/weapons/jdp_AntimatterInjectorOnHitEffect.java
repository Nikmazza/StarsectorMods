...
public class jdp_AntimatterInjectorOnHitEffect extends BaseCombatLayeredRenderingPlugin implements OnHitEffectPlugin {
	...
	public jdp_AntimatterInjectorOnHitEffect() {
	}
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		jdp_AntimatterInjectorOnHitEffect effect = new jdp_AntimatterInjectorOnHitEffect(projectile, (ShipAPI) target, offset);
	...
	public static class ParticleData {
		...
		public Color color = new Color(255,128,51,150);
	...
	public jdp_AntimatterInjectorOnHitEffect(DamagingProjectileAPI proj, ShipAPI target, Vector2f offset) {
		this.proj = proj;
		this.target = target;
		this.offset = offset;
