...
public class jdp_AntimatterInjectorEffect extends CryofluxTransducerEffect {
	...
	public jdp_AntimatterInjectorEffect() {
		super();
	}

	public jdp_AntimatterInjectorEffect(DamagingProjectileAPI projectile, DamagingProjectileAPI prev) {
...
//			Vector2f.add(p.offset, dir, p.offset);
	...
	protected jdp_AntimatterInjectorEffect createTrail(DamagingProjectileAPI projectile, DamagingProjectileAPI prev) {
		return new jdp_AntimatterInjectorEffect(projectile, prev);
	}
