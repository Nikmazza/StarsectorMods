...
public class jdp_FlowerfishHQ extends BaseIndustry implements RouteFleetSpawner, FleetEventListener {
	...
	public boolean isFunctional() {
		return super.isFunctional() && market.getFactionId().equals(Factions.INDEPENDENT);
	}
	...
	public void apply() {
		...
		market.getStats().getDynamic().getMod(Stats.OFFICER_IS_MERC_PROB_MOD).modifyFlat(id, 1);
	...
	public CampaignFleetAPI spawnFleet(RouteData route) {
		...
		FleetParamsV3 params = new FleetParamsV3(
				...
				0f, // linerPts
				0f, // utilityPts
				1f // qualityMod - since the Lion's Guard is in a different-faction market, counter that penalty
				);
		...
		fleet.setFaction(jdp_Factions.JDP_FLOWERFISH, true);
...
//		fleet.addScript(ai);
	...
	public String getRouteSourceId() {
		return getMarket().getId() + "_" + "jdp_flowerfish";
	}
