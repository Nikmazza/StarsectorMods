...
public class VayraModPlugin extends BaseModPlugin {

    public static Logger log = Global.getLogger(VayraModPlugin.class);
    ...
    public void onApplicationLoad() throws Exception {
        ...
        try {
            ...
            Global.getLogger(VayraModPlugin.class).log(Level.ERROR, "VAYRA_SETTINGS.ini loading failed! ;....; " + e.getMessage());
        }
