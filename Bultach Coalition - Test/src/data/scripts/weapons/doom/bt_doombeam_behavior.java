...
public class bt_doombeam_behavior implements EveryFrameWeaponEffectPlugin, BeamEffectPlugin
{
    ...
    static final float VFX_OFFSET = 75f; // moves the origin point for the vfx this many pixels down the weapon's facing angle
    ...
    static final float TIER_TIME = 0.85f; // seconds of firing to go up a tier
