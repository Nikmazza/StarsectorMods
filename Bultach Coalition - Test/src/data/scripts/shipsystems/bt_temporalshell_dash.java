...
public class bt_temporalshell_dash extends BaseShipSystemScript {
    ...
    static {
        ...
        DISTORTION_RADIUS_SCALE.put(HullSize.CAPITAL_SHIP, 550f);
        DISTORTION_INTENSITY_MULT.put(HullSize.CAPITAL_SHIP, 0.09f);
        LIGHTNING_COUNT_SCALE.put(HullSize.CAPITAL_SHIP, 8.0f);
        LIGHTNING_SIZE_SCALE.put(HullSize.CAPITAL_SHIP, 120.0f);
        LIGHTNING_THICKNESS_SCALE.put(HullSize.CAPITAL_SHIP, 10f);
        JITTER_INTENSITY_SCALE.put(HullSize.CAPITAL_SHIP, 1.2f);
        SOUND_PITCH_SCALE.put(HullSize.CAPITAL_SHIP, 0.9f);
        SOUND_VOLUME_SCALE.put(HullSize.CAPITAL_SHIP, 1.1f);
        PARTICLE_SPRITE_SCALE.put(HullSize.CAPITAL_SHIP, 1.2f);
        MAX_SPEED_BONUS_FLAT.put(HullSize.CAPITAL_SHIP, 30f);
