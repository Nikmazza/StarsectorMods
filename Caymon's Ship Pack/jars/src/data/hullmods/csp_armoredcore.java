...
public class csp_armoredcore extends BaseHullMod {
        
    public  Map<Integer,String> LEFT_SELECTOR = new HashMap<>();
    {
        LEFT_SELECTOR.put(0, "csp_deputy_miningblaster");
        LEFT_SELECTOR.put(1, "csp_deputy_swarmer");
        LEFT_SELECTOR.put(2, "csp_deputy_chaingun");
    }
    
    public Map<Integer,String> RIGHT_SELECTOR = new HashMap<>();
    {
        RIGHT_SELECTOR.put(0, "csp_deputy_jackhammer");
        RIGHT_SELECTOR.put(1, "csp_deputy_heavymg");
        RIGHT_SELECTOR.put(2, "csp_deputy_chaingunR");
    }
    
    private final Map<String, Integer> SWITCH_TO_LEFT = new HashMap<>();
    {
        SWITCH_TO_LEFT.put("csp_deputy_miningblaster",1);
        SWITCH_TO_LEFT.put("csp_deputy_swarmer",2);
        SWITCH_TO_LEFT.put("csp_deputy_chaingun",0);
    }
	
    private final Map<String, Integer> SWITCH_TO_RIGHT = new HashMap<>();
    {
		SWITCH_TO_RIGHT.put("csp_deputy_jackhammer",1);
        SWITCH_TO_RIGHT.put("csp_deputy_heavymg",2);
        SWITCH_TO_RIGHT.put("csp_deputy_chaingunR",0);
    }
    
    private final Map<Integer,String> LEFTSWITCH = new HashMap<>();
    {
        LEFTSWITCH.put(0,"csp_selector_miningblaster");
        LEFTSWITCH.put(1,"csp_selector_expandedswarmer");
        LEFTSWITCH.put(2,"csp_selector_chaingunL");
    }
    private final Map<Integer,String> RIGHTSWITCH = new HashMap<>();
    {
        RIGHTSWITCH.put(0,"csp_selector_jackhammer");
        RIGHTSWITCH.put(1,"csp_selector_hmg");
        RIGHTSWITCH.put(2,"csp_selector_chaingunR");
    }    
    
    private final String leftslotID = "WS0013";
    private final String rightslotID = "WS0012";
