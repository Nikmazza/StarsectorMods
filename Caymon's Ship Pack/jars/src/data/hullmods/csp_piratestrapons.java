...
public class csp_piratestrapons extends BaseHullMod {
        
    public  Map<Integer,String> LEFT_SELECTOR = new HashMap<>();
    {
        LEFT_SELECTOR.put(0, "csp_annihilatorarm");
        LEFT_SELECTOR.put(1, "csp_autocannonarm");
        LEFT_SELECTOR.put(2, "csp_motorheadbreacharm");
    }
    
    public Map<Integer,String> RIGHT_SELECTOR = new HashMap<>();
    {
        RIGHT_SELECTOR.put(0, "csp_lagarm");
        RIGHT_SELECTOR.put(1, "csp_irpulsearm");
        RIGHT_SELECTOR.put(2, "csp_thumperarm");
    }
    
    private final Map<String, Integer> SWITCH_TO_LEFT = new HashMap<>();
    {
        SWITCH_TO_LEFT.put("csp_annihilatorarm",1);
        SWITCH_TO_LEFT.put("csp_autocannonarm",2);
        SWITCH_TO_LEFT.put("csp_motorheadbreacharm",0);
    }
	
    private final Map<String, Integer> SWITCH_TO_RIGHT = new HashMap<>();
    {
		SWITCH_TO_RIGHT.put("csp_lagarm",1);
        SWITCH_TO_RIGHT.put("csp_irpulsearm",2);
        SWITCH_TO_RIGHT.put("csp_thumperarm",0);
    }
    
    private final Map<Integer,String> LEFTSWITCH = new HashMap<>();
    {
        LEFTSWITCH.put(0,"csp_selector_annihilator");
        LEFTSWITCH.put(1,"csp_selector_autocannon");
        LEFTSWITCH.put(2,"csp_selector_motorbreach");
    }
    private final Map<Integer,String> RIGHTSWITCH = new HashMap<>();
    {
        RIGHTSWITCH.put(0,"csp_selector_LAG");
        RIGHTSWITCH.put(1,"csp_selector_irpulsearm");
        RIGHTSWITCH.put(2,"csp_selector_thumper");
    }    
