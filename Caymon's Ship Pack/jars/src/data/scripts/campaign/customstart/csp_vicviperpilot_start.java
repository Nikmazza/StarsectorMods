...
public class csp_vicviperpilot_start extends CustomStart {

    protected List<String> ships = new ArrayList<>(Arrays.asList(new String[]{
        "csp_vicviperpilot_starter","mora_Strike"
    }));
                ...
                Global.getSector().addScript(new EveryFrameScript() {
                    ...
                    public void advance(float amount) {
                        ...
                        for (FleetMemberAPI member : fleet.getFleetData().getMembersListCopy()) {
                            if (member.getShipName().contentEquals("Vic Viper")) {
                                done = true;
                                break;
                            }

                            member.setShipName("Vic Viper");
                        }
                    }
