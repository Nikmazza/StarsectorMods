...
public class ModifiedFortressShieldStats extends BaseShipSystemScript {
	...
	public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
		...
		stats.getShieldDamageTakenMult().modifyMult(id, 1f - .3f * effectLevel);
	...
	public StatusData getStatusData(int index, State state, float effectLevel) {
		if (index == 0) {
			return new StatusData("shield absorbs 3x damage", false);
		}
//		else if (index == 1) {
