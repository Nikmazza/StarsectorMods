...
public class ssp_ThunderCharge extends BaseShipSystemScript {
    ...
    public void apply(MutableShipStatsAPI stats, String id, State state, float effectLevel) {
        ...
        if(ship.getVariant().hasHullMod("ssp_SYS_p")){ arc_fluxAmount=50; arc=80;Damage=3;Interval=0.60f;}
        if(ship.getVariant().hasHullMod("ssp_SYS_s")){ arc_fluxAmount=0;Interval=1.2f;}
