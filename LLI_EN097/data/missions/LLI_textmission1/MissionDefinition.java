...
public class MissionDefinition implements MissionDefinitionPlugin {
	...
	public void defineMission(MissionDefinitionAPI api) {
		...
		api.addToFleet(FleetSide.PLAYER, "ssp_naga_standard", FleetMemberType.SHIP,true);
		api.addToFleet(FleetSide.PLAYER, "ssp_midkarni_standard", FleetMemberType.SHIP,true);
		
		
		api.addToFleet(FleetSide.PLAYER, "ssp_superdestoryer_standard", FleetMemberType.SHIP,true);	
		...
		api.addToFleet(FleetSide.PLAYER, "ssp_Estatics_standard", FleetMemberType.SHIP,true);
