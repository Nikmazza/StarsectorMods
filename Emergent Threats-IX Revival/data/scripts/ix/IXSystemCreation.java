...
public class IXSystemCreation {
	...
	public static void generate(SectorAPI sector) {
		...
		if (isFortress()) {
			String modName = "EmergentThreats_IX_Revival";
			if (LunaSettings.getBoolean(modName, "ix_trinity_enabled")) market_starbase.addIndustry("tw_tributary_port");
			else market_starbase.addIndustry("tw_orbital_farms");
		}
		...
		else generateEmptyTrinity(sector);
	}
	...
	private static void generateTrinity(SectorAPI sector) {
		...
		market.addCondition("ix_infrastructure");
	...
	private static void generateEmptyTrinity(SectorAPI sector) {
		//make the system
		StarSystemAPI system = sector.createStarSystem("Danu");
		system.setBackgroundTextureFilename("graphics/backgrounds/background_galatia.jpg");
		...
		planet1.setFaction("independent");
		planet1.setCustomDescriptionId("tw_danu_gorias_empty");
		planet1.setInteractionImage("illustrations", "tw_gorias_illus");
		
		MarketAPI market = Global.getFactory().createMarket("tw_gorias_market", planet1.getName(), 3);
		...
		//habitable farming station orbiting Murias
		SectorEntityToken starbase = system.addCustomEntity("tw_danu_murias_station", "Emerald Station", "ix_tw_station", "independent");
		...
		MarketAPI market_starbase = Global.getFactory().createMarket("tw_danu_station_market", starbase.getName(), 5);
		market_starbase.setFactionId("independent");
		...
		market_starbase.addIndustry(Industries.POPULATION);
		market_starbase.addIndustry(Industries.SPACEPORT);
		market_starbase.addIndustry("tw_orbital_farms");
		market_starbase.addIndustry(Industries.ORBITALWORKS);
		market_starbase.addIndustry(Industries.LIGHTINDUSTRY); 
		market_starbase.addIndustry(Industries.PATROLHQ);
		market_starbase.addIndustry(Industries.ORBITALSTATION_HIGH);
		...
		//empty cryovolcanic world
		PlanetAPI planet3 = system.addPlanet("tw_danu_falais", star2, "Falais", "cryovolcanic", 360, 70, 1200, 70);
		planet3.setCustomDescriptionId("tw_danu_falais_empty");
		//planet3.setInteractionImage("illustrations", "tw_falais_illus");

		MarketAPI market3 = planet3.getMarket();
		market3.setSurveyLevel(MarketAPI.SurveyLevel.FULL);
		market3.setPrimaryEntity(planet3);
		market3.addCondition(Conditions.ORE_ABUNDANT);
		market3.addCondition(Conditions.RARE_ORE_RICH);
		...
		starbase2.setCircularOrbitPointingDown(planet4, 0, 150, 360);
		//starbase2.setCircularOrbitPointingDown(star, 220, 5500, 360);
		starbase2.setCustomDescriptionId("tw_danu_bodach_freehold_empty");
		starbase2.setInteractionImage("illustrations", "tw_station2_illus");
		...
		market_starbase2.addIndustry(Industries.MILITARYBASE, new ArrayList<Commodities>(Arrays.asList(Commodities.GAMMA_CORE)));
		market_starbase2.addIndustry(Industries.GROUNDDEFENSES);
		market_starbase2.addIndustry(Industries.ORBITALSTATION_HIGH);
		...
		//conquered fort culmen
		SectorEntityToken starbase3 = system.addCustomEntity("tw_danu_culmen_station", "Fort Culmen", "ix_tw_station3", "tritachyon");
		
		starbase3.setCircularOrbitPointingDown(star, 70, 10500, 700);
		starbase3.setCustomDescriptionId("tw_danu_fort_culmen_empty");
		starbase3.setInteractionImage("illustrations", "tw_station3_illus");
		
		MarketAPI market_starbase3 = Global.getFactory().createMarket("tw_danu_culmen_market", starbase3.getName(), 3);
		market_starbase3.setFactionId("tritachyon");
		
		market_starbase3.setSurveyLevel(MarketAPI.SurveyLevel.FULL);
		market_starbase3.setPrimaryEntity(starbase3);

		market_starbase3.addCondition(Conditions.POPULATION_3);
		
		market_starbase3.addIndustry(Industries.POPULATION);
		market_starbase3.addIndustry(Industries.SPACEPORT);
		market_starbase3.addIndustry(Industries.WAYSTATION);
		market_starbase3.addIndustry(Industries.MILITARYBASE);
		market_starbase3.addIndustry(Industries.HEAVYBATTERIES);
		market_starbase3.addIndustry(Industries.BATTLESTATION_HIGH);
