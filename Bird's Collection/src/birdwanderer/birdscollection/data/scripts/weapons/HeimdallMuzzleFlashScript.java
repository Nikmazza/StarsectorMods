...
package birdwanderer.birdscollection.data.scripts.weapons;
...
public class HeimdallMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(200,200,200,165));
    }
    ...
    static {
        PARTICLE_SIZE_MAX.put("default", 30f);
    }
    ...
    static {
        PARTICLE_DURATION_MAX.put("default", 1.8f);
    }
    ...
    //Instantiator
    public HeimdallMuzzleFlashScript() {}
