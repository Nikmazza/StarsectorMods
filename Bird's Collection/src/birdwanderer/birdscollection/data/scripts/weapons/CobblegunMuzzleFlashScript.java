...
public class CobblegunMuzzleFlashScript implements EveryFrameWeaponEffectPlugin {
    ...
    */
    ...
    static {
        PARTICLE_COLOR.put("default", new Color(180,180,180,165));
    }
    ...
    static {
        PARTICLE_SIZE_MAX.put("default", 16f);
    }
    ...
    static {
        ...
        PARTICLE_ARC.put("FLASH_ID_2", 180f);
    }
    ...
    //Instantiator
    public CobblegunMuzzleFlashScript() {}
