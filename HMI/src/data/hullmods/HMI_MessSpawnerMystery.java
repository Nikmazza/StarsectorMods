...
public class HMI_MessSpawnerMystery extends BaseHullMod {
	...
	public static class ShardTypeVariants {
		public Map<HMI_MessSpawnerGreater.ShardType, WeightedRandomPicker<String>> variants = new HashMap<HMI_MessSpawnerGreater.ShardType, WeightedRandomPicker<String>>();
		public ShardTypeVariants() {
		}
		public WeightedRandomPicker<String> get(HMI_MessSpawnerGreater.ShardType type) {
	...
	public static Map<HullSize, HMI_MessSpawnerGreater.ShardTypeVariants> variantData = new HashMap<HullSize, HMI_MessSpawnerGreater.ShardTypeVariants>();
	static {
...
//		fighters.get(ShardType.POINT_DEFENSE).add("drone_feeder_stripper", 10f);
		...
		HMI_MessSpawnerGreater.ShardTypeVariants small = new HMI_MessSpawnerGreater.ShardTypeVariants();
		variantData.put(HullSize.FRIGATE, small);

		small.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_stable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_unstable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std", 0.1f);
		small.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std2", 0.1f);
		small.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std3", 0.1f);

		small.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_stable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_unstable_mass_std", 10f);

		small.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_stable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_unstable_mass_std", 10f);
		//small.get(ShardType.ANTI_SHIELD).add("aspect_shieldbreaker_wing", 10f);

		small.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_stable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_unstable_mass_std", 10f);
		//small.get(ShardType.POINT_DEFENSE).add("aspect_shock_wing", 10f);

		small.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_stable_mass_std", 1f);
		small.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_unstable_mass_std", 10f);
		//small.get(ShardType.MISSILE).add("aspect_missile_wing", 10f);


		HMI_MessSpawnerGreater.ShardTypeVariants medium = new HMI_MessSpawnerGreater.ShardTypeVariants();
		variantData.put(HullSize.DESTROYER, medium);

		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_stable_mass_std", 10f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_unstable_mass_std", 5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_energy", 0.1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_beamer", 0.1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_ballistic", 0.1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_ballistic2", 0.1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std2", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std3", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_remnant", 0.01f);
		medium.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_omega", 0.0001f);


		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_stable_mass_std", 10f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_unstable_mass_std", 1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_amalgam_mass_antiarmour", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_amalgam_mass_antiarmour2", 0.5f);

		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_stable_mass_std", 3f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_unstable_mass_std", 6f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_amalgam_mass_antishield", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_amalgam_mass_antishield2", 0.5f);

		medium.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_stable_mass_std", 1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_unstable_mass_std", 5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_amalgam_mass_antiftr", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_amalgam_mass_pd", 0.5f);

		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_unstable_mass_std", 6f);
		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_stable_mass_std", 3f);
		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_missile", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_missile2", 0.5f);
		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_sabot", 0.1f);
		medium.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_harpoon", 0.1f);

		HMI_MessSpawnerGreater.ShardTypeVariants large = new HMI_MessSpawnerGreater.ShardTypeVariants();
		variantData.put(HullSize.CRUISER, large);

		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_unstable_mass_std", 10f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_stable_mass_std", 6f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_energy", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_beamer", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_ballistic", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_ballistic2", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std", 3f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std2", 3f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_std3", 3f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_remnant", 0.1f);
		large.get(HMI_MessSpawnerGreater.ShardType.GENERAL).add("mess_amalgam_mass_omega", 0.01f);

		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_unstable_mass_std", 10f);
		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_stable_mass_std", 3f);
		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_amalgam_mass_antiarmour", 2f);
		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR).add("mess_amalgam_mass_antiarmour2", 2f);

		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_unstable_mass_std", 10f);
		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_amalgam_mass_antishield", 2f);
		large.get(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD).add("mess_amalgam_mass_antishield2", 2f);

		large.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_unstable_mass_std", 10f);
		large.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_amalgam_mass_antiftr", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE).add("mess_amalgam_mass_pd", 1f);

		large.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_unstable_mass_std", 10f);
		large.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_missile", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_missile2", 1f);
		large.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_sabot", 0.5f);
		large.get(HMI_MessSpawnerGreater.ShardType.MISSILE).add("mess_amalgam_mass_harpoon", 0.5f);
	}
	...
	public void advanceInCombat(ShipAPI ship, float amount) {
		...
		HMI_MessSpawnerGreater.ShardSpawnerData data = (HMI_MessSpawnerGreater.ShardSpawnerData) engine.getCustomData().get(key);
		if (data == null) {
			data = new HMI_MessSpawnerGreater.ShardSpawnerData();
		...
		WeightedRandomPicker<HMI_MessSpawnerGreater.ShardType> typePicker = getTypePickerBasedOnLocalConditions(ship);
...
//		splitWeight = 1f;
		...
		float destroyers = 0f;
		float cruisers = 0f;
		List<HMI_MessSpawnerGreater.ShardFadeInPlugin> shards = new ArrayList<HMI_MessSpawnerGreater.ShardFadeInPlugin>();
		while (addedWeight < splitWeight) {
			HMI_MessSpawnerGreater.ShardType type = typePicker.pick();
			...
			float weight = 1f;
			if (cruiser) {
				HMI_MessSpawnerGreater.ShardTypeVariants variants = variantData.get(HullSize.CRUISER);
			...
			if (destroyer && variant == null) {
				HMI_MessSpawnerGreater.ShardTypeVariants variants = variantData.get(HullSize.DESTROYER);
				WeightedRandomPicker<String> variantPicker = variants.get(type);
				variant = variantPicker.pick();
				if (variant != null) {
					weight = 2f;
			...
			if (frigate && variant == null) {
				HMI_MessSpawnerGreater.ShardTypeVariants variants = variantData.get(HullSize.FRIGATE);
				WeightedRandomPicker<String> variantPicker = variants.get(type);
				variant = variantPicker.pick();
				if (variant != null) {
					weight = 1f;
			...
			if (variant != null) {
				...
				HMI_MessSpawnerGreater.ShardFadeInPlugin shard = createShipFadeInPlugin(variant, ship, extraDur, dur, angle);
				shards.add(shard);
...
//		Global.getCombatEngine().addPlugin(createShipFadeInPlugin("shard_right_Attack", ship, 0f, dur));
	...
	public WeightedRandomPicker<HMI_MessSpawnerGreater.ShardType> getTypePickerBasedOnLocalConditions(ShipAPI ship) {
		CombatEngineAPI engine = Global.getCombatEngine();
		...
		WeightedRandomPicker<HMI_MessSpawnerGreater.ShardType> picker = new WeightedRandomPicker<HMI_MessSpawnerGreater.ShardType>();
		...
		picker.add(HMI_MessSpawnerGreater.ShardType.GENERAL, 0.0f + (1f - friends) * 0.4f);
...
//		}
		...
		picker.add(HMI_MessSpawnerGreater.ShardType.POINT_DEFENSE, antiFighter);

		if (antiShield < unlikelyThreshold) antiShield = unlikelyWeight;
		picker.add(HMI_MessSpawnerGreater.ShardType.ANTI_SHIELD, antiShield);

		if (antiArmor < unlikelyThreshold) antiArmor = unlikelyWeight;
		picker.add(HMI_MessSpawnerGreater.ShardType.ANTI_ARMOR, antiArmor);

		if (missile < unlikelyThreshold) missile = unlikelyWeight;
		picker.add(HMI_MessSpawnerGreater.ShardType.MISSILE, missile);
	...
	protected EveryFrameCombatPlugin createShipFadeOutPlugin(final ShipAPI ship, final float fadeOutTime,
															 final List<HMI_MessSpawnerGreater.ShardFadeInPlugin> shards) {
		return new BaseEveryFrameCombatPlugin() {
			...
			protected void pushShipsAway(float amount) {
				...
				float count = 0f;
				for (HMI_MessSpawnerGreater.ShardFadeInPlugin shard : shards) {
...
//								0.5f / dur, 0f, dur, c);
	...
	protected HMI_MessSpawnerGreater.ShardFadeInPlugin createShipFadeInPlugin(final String variantId, final ShipAPI source,
																			  final float delay, final float fadeInTime, final float angle) {

		return new HMI_MessSpawnerGreater.ShardFadeInPlugin(variantId, source, delay, fadeInTime, angle);
	}
