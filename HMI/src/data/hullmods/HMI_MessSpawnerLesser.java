...
public class HMI_MessSpawnerLesser extends BaseHullMod {
	...
	static {
		...
		fighters.get(ShardType.GENERAL).add("drone_feeder_free_wing", 10f);
		fighters.get(ShardType.GENERAL).add("drone_feeder_heavy_free_wing", 1f);

		fighters.get(ShardType.MISSILE).add("drone_feeder_free_wing", 10f);

		fighters.get(ShardType.ANTI_ARMOR).add("drone_feeder_free_wing", 10f);

		fighters.get(ShardType.ANTI_SHIELD).add("drone_feeder_free_wing", 10f);

		fighters.get(ShardType.POINT_DEFENSE).add("drone_feeder_free_wing", 10f);
