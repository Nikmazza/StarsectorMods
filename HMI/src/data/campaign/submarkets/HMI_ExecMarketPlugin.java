...
public class HMI_ExecMarketPlugin extends BaseSubmarketPlugin {
    ...
    static {
        ...
        SCRAPYARD_FACTIONS.add("hmi_exec", 10f);
    }
    ...
    public void updateCargoPrePlayerInteraction() {
        ...
        if (okToUpdateShipsAndWeapons()) {
            ...
            int weapons = 20 + Math.max(0, market.getSize() - 1) + (Misc.isMilitary(market) ? 5 : 0);
            int fighters = 6 + Math.max(0, (market.getSize() - 3) / 2) + (Misc.isMilitary(market) ? 2 : 0);
            ...
            addWeapons(weapons, weapons + 5, 2, factionPicker);
