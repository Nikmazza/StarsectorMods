...
public class Aphrodite {
	...
	public void generate(SectorAPI sector) {
		...
		PlanetAPI aphrodite_b = system.addPlanet("amor", aphrodite_star, "Cosmara", "toxic", 270, 140, 3800, 80);
		...
		PlanetAPI stirling = system.addPlanet("afecto", aphrodite_star, "Genesis", "desert", 220, 160, 1300, 180);
		...
		PlanetAPI leeds = system.addPlanet("cuidado", aphrodite_star, "Lyra Prime", "barren", 180, 90, 7300, 210);
