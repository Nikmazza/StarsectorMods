...
public class anvilgen implements SectorGeneratorPlugin {
    ...
    public static void initFactionRelationships(SectorAPI sector) {
        ...
        keruvim.setRelationship(hegemony.getId(), RepLevel.SUSPICIOUS);
        ...
        keruvim.setRelationship(persean.getId(), RepLevel.FRIENDLY);
        ...
        keruvim.setRelationship("interstellarimperium", RepLevel.WELCOMING);
        keruvim.setRelationship("star_federation", RepLevel.SUSPICIOUS);
