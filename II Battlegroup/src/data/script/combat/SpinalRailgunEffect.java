package II_BG.data.scripts.combat;

import com.fs.starfarer.api.Global;
import com.fs.starfarer.api.combat.*;
import org.lwjgl.util.vector.Vector2f;
import II_BG.data.scripts.util.CollisionUtils;
...
public class SpinalRailgunEffect implements OnFireEffectPlugin, EveryFrameWeaponEffectPlugin {

    static final int maxPierce = 10;
    static final float minTimeBetweenHits = 0.05f;
    ...
    static final Color chargeGlowColor = new Color(124, 166, 255);
