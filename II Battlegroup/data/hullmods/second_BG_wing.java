...
public class second_BG_wing extends BaseHullMod {
	...
	private static final float ARMOR_BONUS = 25f;
	private static final float CAPACITY_MULT = 1.08f;
	private static final float DISSIPATION_MULT = 1.08f;
