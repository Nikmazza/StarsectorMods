...
public class NameListUtil {
	...
	public static String KATO_BLUEPRINT = "Received Automated Cruiser Blueprints";
	
	//public static String INVITATION_POEM = "The white horse is not a horse,\nThe heavenly prison is not a prison,\nThe learned sage is not a sage,\nThis humble personage is not a person\n\nCome find me when you know how.";
	/**
	白馬非馬
	天獄非獄
	君子非子
