...
public class AIFleetCommander extends BaseCharacterBackground {
	...
	public void addTooltipForSelection(TooltipMakerAPI tooltip, FactionSpecAPI factionSpec, NexFactionConfig factionConfig, Boolean expanded) {
		...
		if (expanded) {
			String s = "Gain the AI Fleet Commander skill, which reduces deployment cost for AI ships in your fleet. Having this background while resolving the Project Mayfly bounty non-violently will earn you the project's automated ship blueprints rather than this skill.";
            tooltip.addSpacer(10f);
            tooltip.addPara(s, 0f, Misc.getTextColor(), Misc.getHighlightColor(), SKILL_NAME, "Project Mayfly");
		}
	}
}