...
public class SupremeLeadership extends SCBaseSkillPlugin {
    ...
    public void addTooltip(SCData data, TooltipMakerAPI tooltip) {
		...
		String s = "15%% to combat readiness for Lion's Guard";
		if (isSFC) s += " and Sindrian Fuel Company ships"; 
		else s += " ships";
		tooltip.addPara(s, 0f, Misc.getHighlightColor(), Misc.getHighlightColor());
		tooltip.addPara("10%% to combat readiness for midline ships", 0f, Misc.getHighlightColor(), Misc.getHighlightColor());
    ...
    public void applyEffectsBeforeShipCreation(SCData data, MutableShipStatsAPI stats, ShipVariantAPI variant, ShipAPI.HullSize hullSize, String id) {
		...
		if (manufacturer.equals("Midline")) bonus = ML_BOOST;
		else if (manufacturer.equals("Lion's Guard") 
				|| manufacturer.equals("Sindrian Diktat")
				|| manufacturer.equals("Sindrian Fuel Company")) bonus = LG_BOOST;
