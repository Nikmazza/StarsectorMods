...
public class ReactorMonitoring extends SCBaseSkillPlugin {
    ...
    public void addTooltip(SCData data, TooltipMakerAPI tooltip) {
		...
		tooltip.addPara("Acquire the Reactor Chamber and Drive Field adaptive hullmods", 0f, Misc.getTextColor(), Misc.getHighlightColor(), "Reactor Chamber", "Drive Field");
    }
	...
	public void onActivation(SCData data) {
		...
		if (data.isPlayer() && !Global.getSector().getMemoryWithoutUpdate().is("$gave_RM_hullmods", true)) {
			...
			player.addHullMod("vice_adaptive_drive_field");
