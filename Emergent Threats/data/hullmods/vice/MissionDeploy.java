...
public class MissionDeploy extends BaseHullMod {
	...
	public void applyEffectsBeforeShipCreation(HullSize hullSize, MutableShipStatsAPI stats, String id) {
		...
		if (stats.getVariant().hasHullMod("vice_experimental_hull_hvb") && stats.getFleetMember() != null && !ALPHA_ID.equals(stats.getFleetMember().getCaptain().getAICoreId())) {
		...
		else if (stats.getVariant().hasHullMod("automated") && stats.getFleetMember() != null && !BETA_ID.equals(stats.getFleetMember().getCaptain().getAICoreId())) {
			PersonAPI person = Global.getFactory().createPerson();
