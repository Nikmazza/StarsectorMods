...
public class ConvertShuttleBomber extends BaseHullMod {
	
	//Adding/removing shuttles, adjusting launch bay count, and clearing LPCs handled by Vast Launch Bays
	private static int MOD_COST = 50;
	private static int MIN_BAY_COUNT = 2;
	private static String WING_ID = "vice_kite_bmr_wing";
	private static String THIS_MOD = "vice_convert_shuttle_bomber";
	private static String CONFLICT_MOD_ID = "vice_convert_shuttle_attack";
