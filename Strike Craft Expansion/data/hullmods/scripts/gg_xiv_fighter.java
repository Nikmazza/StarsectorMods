...
public class gg_xiv_fighter extends BaseHullMod {
	...
	private static final float CAPACITY_MULT = 1.20f;
	private static final float DISSIPATION_MULT = 1.20f;
	private static final float HANDLING_MULT = 0.90f;
