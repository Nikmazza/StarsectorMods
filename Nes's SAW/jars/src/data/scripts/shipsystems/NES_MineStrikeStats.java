...
public class NES_MineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {
	...
	public static final Color JITTER_COLOR = new Color(255,155, 175, 75);
	public static final Color JITTER_UNDER_COLOR = new Color(255, 155, 175, 155);
