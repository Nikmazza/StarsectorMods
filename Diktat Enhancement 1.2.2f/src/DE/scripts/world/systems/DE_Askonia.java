...
public class DE_Askonia {
    ...
    public void generate(SectorAPI sector) {
        ...
        if (!DEenablelitemode) {
            PlanetAPI drakon = system.addPlanet("drakon", system.getEntityById("askonia"), "Drakon", "frozen1", 280, 150, 12000, 1000); // 1000 orbit day
            ...
            NascentGravityWellAPI well = Global.getSector().createNascentGravityWell(drakon, 50f); // 50f
