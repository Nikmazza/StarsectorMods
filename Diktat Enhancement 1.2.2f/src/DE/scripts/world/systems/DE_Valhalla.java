...
public class DE_Valhalla {
    ...
    public void generate(SectorAPI sector) {
        ...
        // gravity well i forgot
        LocationAPI hyper = Global.getSector().getHyperspace();
        NascentGravityWellAPI well = Global.getSector().createNascentGravityWell(midgard, 170f);
        well.autoUpdateHyperLocationBasedOnInSystemEntityAtRadius(midgard, 10f);
