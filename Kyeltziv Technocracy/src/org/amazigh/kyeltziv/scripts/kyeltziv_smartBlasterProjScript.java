...
//	run "engine.addPlugin(kyeltziv_smartBlasterProjScript(proj, target));" with:
//		kyeltziv_smartBlasterProjScript being replaced with your new class name
...
public class kyeltziv_smartBlasterProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float TURN_RATE = 250f;
	 ...
	 */
	public kyeltziv_smartBlasterProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
