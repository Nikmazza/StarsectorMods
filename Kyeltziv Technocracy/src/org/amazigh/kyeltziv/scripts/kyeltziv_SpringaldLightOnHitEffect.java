...
public class kyeltziv_SpringaldLightOnHitEffect implements OnHitEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		if (target instanceof ShipAPI) {
			...
			if (shieldHit) {
				...
				float pierceChance = (((ShipAPI)target).getHardFluxLevel() - 0.1f) * 0.85f; // lowering pierce chance a little, because this is the light version!
