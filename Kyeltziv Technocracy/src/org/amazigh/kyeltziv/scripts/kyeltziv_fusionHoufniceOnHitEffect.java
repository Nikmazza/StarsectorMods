...
public class kyeltziv_fusionHoufniceOnHitEffect implements OnHitEffectPlugin {
	
	private static final Color COLOR_P = new Color(255,95,75,255);
    private static final Color COLOR_X = new Color(255,145,120,125);
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target, Vector2f point, boolean shieldHit, ApplyDamageResultAPI damageResult, CombatEngineAPI engine) {
		...
		if (0.2f >= (float) Math.random()) {
			...
			Global.getSoundPlayer().playSound("explosion_flak", 0.75f, 0.6f, point, tagVel);
