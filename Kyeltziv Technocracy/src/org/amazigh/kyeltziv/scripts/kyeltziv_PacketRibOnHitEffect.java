...
public class kyeltziv_PacketRibOnHitEffect implements OnHitEffectPlugin {
	...
	public void onHit(DamagingProjectileAPI projectile, CombatEntityAPI target,
        ...
        engine.spawnExplosion(point, target.getVelocity(), new Color(210,150,50,80), 15f, 0.2f);
	}
