...
public class kyeltziv_GunPlatform_support extends BaseHullMod {
	...
	public static final float FLUX_RANGE_BONUS = 60f;
	public static final float PD_RANGE_MALUS = 30f;
	...
	public void advanceInCombat(ShipAPI ship, float amount){
		...
		stats.getNonBeamPDWeaponRangeBonus().modifyPercent(spec.getId(), -PD_RANGE_MALUS);
		stats.getBeamPDWeaponRangeBonus().modifyPercent(spec.getId(), -PD_RANGE_MALUS);
