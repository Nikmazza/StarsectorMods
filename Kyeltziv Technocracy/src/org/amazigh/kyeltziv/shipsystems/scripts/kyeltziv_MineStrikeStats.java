...
public class kyeltziv_MineStrikeStats extends BaseShipSystemScript implements MineStrikeStatsAIInfoProvider {

	// basically the vanilla mine strike script, but with commented unused lines stripped to save filesize	
	protected static float MINE_RANGE = 800f; // shorter range than vanilla minestrike for balans
