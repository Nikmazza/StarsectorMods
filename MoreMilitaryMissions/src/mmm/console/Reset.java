...
import mmm.missions.MmmMilitaryCustomBounty;
...
public class Reset implements BaseCommand {
    ...
    public CommandResult runCommand(String args, CommandContext context) {
        ...
        Console.showMessage("Defense Mission Difficulty reset.");
        Global.getSector().getMemoryWithoutUpdate().unset(MmmMilitaryCustomBounty.DIFFICULTY_KEY);
        Console.showMessage("Military Custom Bounty Difficulty reset.");
