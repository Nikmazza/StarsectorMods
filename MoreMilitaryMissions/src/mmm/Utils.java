...
//        log.debug("loadSettings");
        ...
        DefenseMission.MAX_ENEMY_FP = getInteger("DmMaxEnemyFp");
        DefenseMission.INVASION_PROB = getFloat("DmInvasionProb");
        ...
        MmmMilitaryCustomBounty.MAX_DIFFICULTY  = getInteger("McbMaxDifficulty");
    }
...
//            log.debug("settingsChanged");
    ...
    public static List<String> allShipRoles() {
        return Arrays.asList(
                ...
                ShipRoles.TUG, ShipRoles.UTILITY, ShipRoles.CIV_RANDOM,
                ShipRoles.THREAT_FABRICATOR, ShipRoles.THREAT_HIVE, ShipRoles.THREAT_OVERSEER,
                ShipRoles.DWELLER_TENDRIL, ShipRoles.DWELLER_MAELSTROM, ShipRoles.DWELLER_EYE, ShipRoles.DWELLER_MAW,
