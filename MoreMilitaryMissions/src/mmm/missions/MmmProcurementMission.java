...
public class MmmProcurementMission extends ProcurementMission {
    ...
    private MarketAPI savedMarket = null;

    @Override
    protected boolean create(MarketAPI createdAt, boolean barEvent) {
        this.savedMarket = createdAt;
...
//            log.debug("no matching commodities in deficit");
    ...
    public void acceptImpl(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        OrbitalMissionBase.acceptCommon(MISSION_ID, getPerson(), savedMarket);
    }
    ...
    protected void endSuccessImpl(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        // 5% on success).  This allows player faction contact at 40% probability, and vanilla 30% on non-player
        // factions.  The reason for adding RepRewards.HIGH here is that person reputation change is not yet applied.
