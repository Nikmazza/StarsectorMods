...
//	run "engine.addPlugin(ASF_coralianProjScript(proj, target));" with:
//		ASF_coralianProjScript being replaced with your new class name
...
public class ASF_CoralianProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final String GUIDANCE_MODE_PRIMARY = "DUMBCHASER";
			//apparently ONE_TURN_TARGET doesn't work and just has the proj disappear :(
