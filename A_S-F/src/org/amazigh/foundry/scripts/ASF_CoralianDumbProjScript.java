...
//	run "engine.addPlugin(ASF_coralianDumbProjScript(proj, target));" with:
//		ASF_coralianDumbProjScript being replaced with your new class name
...
public class ASF_CoralianDumbProjScript extends BaseEveryFrameCombatPlugin {
	...
	private static final float ONE_TURN_TARGET_INACCURACY = 1f;
	 ...
	 */
	public ASF_CoralianDumbProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
