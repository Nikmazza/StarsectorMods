...
//	run "engine.addPlugin(ASF_SumakeProjScript(proj, target));" with:
//		ASF_SumakeProjScript being replaced with your new class name
...
public class ASF_SumakeProjScript extends BaseEveryFrameCombatPlugin {
	 ...
	 */
	public ASF_SumakeProjScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
		this.proj = proj;
		this.target = target;
